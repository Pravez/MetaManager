...
var bot1 = MetaServer.addLogicalBot(new LogicalBot(new Bot({position:{x:2, y:2}}), 'localhost', 15000));
var bot2 = MetaServer.addLogicalBot(new LogicalBot(new Bot({position:{x:2, y:2, z:3}}), 'localhost', 16000));
